  ...
  <div id="body">
    ...
    <div id="main">
      <div id="search">
        ...
        <p class="route"><router-link to="" class="linkto">文档中心</router-link>&gt<router-link to="" class="linkto">API接口</router-link>&gt文字识别</p>
      </div>
       <div class="from_group">
        <div class="blog">
          <div class="bolg_title"><img src="../assets/产品博客/icon.png" class="icon"/></img>文字识别</div>
