<template>
  ...
  <div id="body">
    ...
    <div id="main">
      <div id="search">
        <p class="route">控制台&nbsp&nbsp&gt<router-link to="" class="linkto">&nbsp&nbspSDK下载</router-link></p>
      </div>
      <div class="card4this" style="width: 100%;">
        ...
        <el-row >
          <el-col :span="14"><div class="grid-content bg-purple">
            ...
            <div>
              ...
              <p style="font-size: 15px;font-weight: 600">检测出图片中的人脸并标记出位置信息</p>
              </div>
              <div>
          ...
          <el-col :span="10"><div class="grid-content bg-purple">
            ...
            <el-card style="width: 350px;height: 460px;margin-top:1rem;" :body-style="{padding:'0px'}">
            <p class="title4card">人脸对比</p>
            <div class="card4footer2">
            </div>
            <div>
              <div class="content4card">
              <p style="font-size: 15px;font-weight: 600">比对两张图片中人脸相似度，并返回相似度分值</p>
              </div>
              <div>
                <el-button class="button4card">SDK下载</el-button>
              </div>
        ...
        <el-row>
          <el-col :span="14"><div class="grid-content bg-purple">
            <el-card style="width: 350px;height: 460px;margin-top:1rem;" :body-style="{padding:'0px'}">
            <p class="title4card">人脸查找</p>
            <div class="card4footer3">
            </div>
            <div>
              <div class="content4card">
              <p style="font-size: 15px;font-weight: 600">在指定人脸集合中，找到最相似的人脸</p>
              </div>
              <div>
                <el-button class="button4card">SDK下载</el-button>
              </div>
        ...
        <el-row >
          <el-col :span="14"><div class="grid-content bg-purple">
            <el-card style="width: 350px;height: 460px;margin-top:1rem;" :body-style="{padding:'0px'}">
            <p class="title4card">去模糊化</p>
            <div class="card4footer5">
            </div>
            <div>
              <div class="content4card">
              <p style="font-size: 15px;font-weight: 600">将当前图片清晰度提高</p>
              </div>
              <div>
                <el-button class="button4card">SDK下载</el-button>
              </div>
          ...
          <el-col :span="10"><div class="grid-content bg-purple">
            ...
            <div>
              <div class="content4card">
              <p style="font-size: 15px;font-weight: 600">对小客车车牌进行识别</p>
              </div>
              <div>
                <el-button class="button4card">SDK下载</el-button>
              </div>
...
span{
  ...
  .card4footer{
    background-image: url("../assets/控制台/SDK下载/人脸检测.png");
    padding: 75.15% 0 0;
    background-size: cover;
  }

  .card4footer2{
    background-image: url("../assets/控制台/SDK下载/人脸对比.png");
    padding: 75.15% 0 0;
    background-size: cover;
  }

    .card4footer3{
    background-image: url("../assets/控制台/SDK下载/人脸查找.png");
    padding: 75.15% 0 0;
    background-size: cover;
  }
    .card4footer4{
    background-image: url("../assets/控制台/SDK下载/身份证识别.png");
    padding: 75.15% 0 0;
    background-size: cover;
  }
    .card4footer5{
    background-image: url("../assets/控制台/SDK下载/去模糊化.png");
    padding: 75.15% 0 0;
    background-size: cover;
  }
    .card4footer6{
    background-image: url("../assets/控制台/SDK下载/车牌识别.png");
    padding: 75.15% 0 0;
    background-size: cover;
  }
