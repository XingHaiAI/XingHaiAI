    ...
    <p id="txtApp">应用场景</p>
          <div class="card4this" style="width: 100%;">
            ...
            <div>
              ...
              <p style="font-size: 0.16rem;font-weight: 330">摆脱生僻字和拼音障碍，将所输入文字，直接用语音的方式输入，让输入法更加便捷</p>
              </div>
            </div>
          </el-card> </div></el-col>
          <el-col :span="10"><div class="grid-content bg-purple"><el-card style="width: 3.36rem;height: 4rem" :body-style="{padding:'0rem'}">
            ...
            <div class="content4card">
              <p style="font-size: 0.16rem;font-weight: 330">搜索内容直接以语音的方式输入，让搜索更加高效</p>
            </div>
          </el-card></div></el-col>
...
<style scoped>
  ...
  .secondBackground{
    ...
    width: 100%;
    height: 50%;
    background-image: url("../assets/语音识别/语音识别-功能介绍.png");
