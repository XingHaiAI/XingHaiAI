  ...
  <div style="min-width: 13.6rem">
    <div id="AIhead" class="firstBackground">
      ...
      <div class="table4this" style="margin-left: 20%">
        <tr style="font-size: 0.60rem;color: white;letter-spacing: 0.06rem;">行驶证识别</tr>
    ...
    <div id="AIbodyfir">
      ...
      <a id="introducecontent">支持对机动车驾驶证正页的关键字段识别，包括号牌号码、车辆类型、所有人、住址、<br/>
        使用性质、品牌型号、车辆识别代号、发动机号码、注册日期、发证日期</a>
    </div>
          ...
          <el-row :gutter="550" style="width: 13rem">
              ...
              <el-card style="width: 3.36rem;height: 4rem;margin-right: 2rem" :body-style="{padding:'0rem'}">
                ...
                <div>
                  ...
                  <div class="content4card">
                    <p style="font-size: 0.16rem;font-weight: 330">运输服务类应用，使用驾驶证和行驶证识别对注册司机进行快速等级，降低驾驶员的输入成本，准确快速便捷</p>
                  </div>
                </div>
              </el-card> </div></el-col>
            <el-col :span="10"><div class="grid-content bg-purple">
              <el-card style="width: 3.36rem;height: 4.00rem" :body-style="{padding:'0rem'}">
                ...
                <div class="content4card">
                  <p style="font-size: 0.16rem;font-weight: 330">交通信息服务类应用，使用驾驶证和行驶证识别实现车主信息的自动识别和录入，为车主提供相关信息的推送，减少用户输入成本，提升体验</p>
                </div>
              </el-card></div></el-col>
...
<style scoped>
  ...
  .firstBackground{
    ...
    width: 100%;
    height: 50%;
    background-image: url("../assets/banner/行驶证识别.jpg");
  ...
  .secondBackground{
    ...
    width: 100%;
    height: 50%;
    background-image: url("../assets/行驶证识别/功能介绍.png");
    background-size: 100% 100%;
  }
  .functionButton{
    color: black;
  ...
  .card4footer{
    background-image: url("../assets/行驶证识别/司机身份认证.png");
    width: 100%;
    height: 50%;
    background-size: 100% 100%;
    padding: 0;
  ...
  .card4footer2{
    background-image: url("../assets/行驶证识别/车主服务应用.png");
    width: 100%;
    height: 50%;
    background-size: 100% 100%;
    padding: 0;
