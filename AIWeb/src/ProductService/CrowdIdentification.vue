  ...
  <div style="min-width: 13.6rem">
    <div id="AIhead" class="firstBackground">
      ...
      <div class="table4this" align="center" style="margin-left: 0%">
        <tr style="font-size: 0.60rem;letter-spacing: 0.06rem;color:white;">人重识别</tr>
        ...
        <div style="margin-right: auto;margin-left: 2.45rem;margin-top:0.50rem;width: 60%">
          <el-row :gutter="550" style="width: 13rem">
              ...
              <el-card style="width: 3.36rem;height: 4rem;margin-right: 2rem" :body-style="{padding:'0rem'}">
                ...
                <div>
                  ...
                  <div class="content4card">
                    <p style="font-size: 0.16rem;font-weight: 330">在视频中对人体进行追踪，根据人体移动方向及速度，调整摄像头对人进行追踪拍摄。</p>
                  </div>
                </div>
              </el-card> </div></el-col>
            <el-col :span="10"><div class="grid-content bg-purple"><el-card style="width: 3.36rem;height: 4rem" :body-style="{padding:'0rem'}">
              ...
              <div class="content4card">
                <p style="font-size: 0.16rem;font-weight: 330">利用人体检测技术，应用能够轻松识别出图像或视频中人体并技术，从而在零售商业、机场或学校等场所进行基于人体的人流量或到场率统计。</p>
              </div>
            </el-card></div></el-col>
...
<style scoped>
  ...
  .firstBackground{
    ...
    width: 100%;
    height: 50%;
    background-image: url("../assets/banner/人重识别.jpg");
  ...
  .secondBackground{
    ...
    width: 100%;
    height: 50%;
    background-image: url("../assets/人重识别/功能介绍.png");
    background-size: 100% 100%;
  }
  .functionButton{
    color: black;
  ...
  .card4footer{
    background-image: url("../assets/人重识别/人体追踪.png");
    width: 100%;
    height: 50%;
    background-size: 100% 100%;
    padding: 0;
  ...
  .card4footer2{
    background-image: url("../assets/人重识别/人流量统计.png");
    width: 100%;
    height: 50%;
    background-size: 100% 100%;
    padding: 0;
